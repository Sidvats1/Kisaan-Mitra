...
class _ScreenGenerationState extends State<ScreenGeneration> {
  ...
  _fetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (double.parse(dataModelApi.feeds[0].field3).toInt() >= 18 &&
          double.parse(dataModelApi.feeds[0].field3).toInt() < 24) {
        var str = {
        ...
        coins.add(str);
      } else if (double.parse(dataModelApi.feeds[0].field3).toInt() >= 24 &&
      ...
      if (double.parse(dataModelApi.feeds[0].field1).toInt() >= 90 &&
          double.parse(dataModelApi.feeds[0].field1).toInt() <= 100) {
        var str = {
        ...
        coins.add(str);
          ...
          double.parse(dataModelApi.feeds[0].field1).toInt() < 90) {
        var str = {
          'icon': 'assets/drip.png',
          'name': 'Moisture',
          'value': '${double.parse(dataModelApi.feeds[0].field1).toInt()}%',
